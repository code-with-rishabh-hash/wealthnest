    ...
    <>
      <div style={CRD}>
        ...
        {[
          ...
          <div key={k as string} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', fontSize: 13, borderBottom: `1px solid ${T.border}` }}>
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
        <Button variant="outline" full onClick={doExport}><Download size={16} /> {'\u{1F4BE}'} Export Backup</Button>
        <Button variant="outline" full onClick={doImport}><Upload size={16} /> {'\u{1F4E5}'} Import Backup</Button>
      </div>
      ...
      <Button
        ...
        style={{ marginTop: 12 }}
      >
        <Trash2 size={16} /> {'\u{1F4A3}'} Emergency Wipe
      </Button>
    </>
  );
}
